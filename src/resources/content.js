...
of Vingroup Innovation Foundation (VINIF), code VINIF.2024.ThS.32. </>,
  ...
  students: {
    display: true,
    title: "Excellent Members of My Research Group",
    people: [
      {
      ...
      },
      {
        ...
        description: <>IT1 K67. First student I supervise Graduation Project. </>,
      },
      {
        name: "Vu Van An",
        avatar: "/images/students/VuVanAn.jpeg",
        description: <>IT1 K69. Best Paper Award Nomination at GECCO 2026.</>,
      },
      {
    ...
    people: [
      {
        ...
        description: "Add enemy details here.",
      },
    ],
  },
};
